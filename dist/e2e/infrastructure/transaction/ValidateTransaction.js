...
const ValidateTransaction = {
    validateStandaloneTx: (transaction, transactionDTO) => {
        ...
        assert_1.deepEqual(transaction.fee, new UInt64_1.UInt64(transactionDTO.transaction.fee));
    ...
    validateAggregateTx: (aggregateTransaction, aggregateTransactionDTO) => {
        ...
        assert_1.deepEqual(aggregateTransaction.fee, new UInt64_1.UInt64(aggregateTransactionDTO.transaction.fee));
    ...
    validateMosaicCreationTx: (mosaicDefinitionTransaction, mosaicDefinitionTransactionDTO) => {
        assert_1.deepEqual(mosaicDefinitionTransaction.parentId, new UInt64_1.UInt64(mosaicDefinitionTransactionDTO.transaction.parentId));
        assert_1.deepEqual(mosaicDefinitionTransaction.mosaicId, new UInt64_1.UInt64(mosaicDefinitionTransactionDTO.transaction.mosaicId));
        ...
        chai_1.expect(mosaicDefinitionTransaction.mosaicProperties.transferable)
            .to.be.equal(true);
        chai_1.expect(mosaicDefinitionTransaction.mosaicProperties.levyMutable)
            .to.be.equal(true);
    },
    validateMosaicSupplyChangeTx: (mosaicSupplyChangeTransaction, mosaicSupplyChangeTransactionDTO) => {
        assert_1.deepEqual(mosaicSupplyChangeTransaction.mosaicId, new UInt64_1.UInt64(mosaicSupplyChangeTransactionDTO.transaction.mosaicId));
    ...
    validateMultisigModificationTx: (modifyMultisigAccountTransaction, modifyMultisigAccountTransactionDTO) => {
        ...
        assert_1.deepEqual(modifyMultisigAccountTransaction.modifications[0], new MultisigCosignatoryModification_1.MultisigCosignatoryModification(modifyMultisigAccountTransactionDTO.transaction.modifications[0].type, modifyMultisigAccountTransactionDTO.transaction.modifications[0].cosignatoryPublicAccount));
    },
    validateNamespaceCreationTx: (registerNamespaceTransaction, registerNamespaceTransactionDTO) => {
        ...
        assert_1.deepEqual(registerNamespaceTransaction.namespaceId, new UInt64_1.UInt64(registerNamespaceTransactionDTO.transaction.namespaceId));
        if (registerNamespaceTransaction.namespaceType === 0) {
            ...
            assert_1.deepEqual(registerNamespaceTransaction.parentId, new UInt64_1.UInt64(registerNamespaceTransactionDTO.transaction.parentId));
        }
    },
