...
describe('CreateTransactionFromDTO', () => {
    describe('TransferTransaction', () => {
        it('standalone', () => {
            ...
            const transferTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(transferTransactionDTO);
            ValidateTransaction_1.default.validateStandaloneTx(transferTransaction, transferTransactionDTO);
        });
        ...
        it('aggregate', () => {
            ...
            ValidateTransaction_1.default.validateAggregateTx(aggregateTransferTransaction, aggregateTransferTransactionDTO);
        });
    });
    describe('RegisterNamespaceTransaction', () => {
        describe('namespace', () => {
            it('standalone', () => {
                ...
                const transferTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(registerNamespaceTransactionDTO);
                ValidateTransaction_1.default.validateStandaloneTx(transferTransaction, registerNamespaceTransactionDTO);
            });
            it('aggregate', () => {
                ...
                const aggregateRegisterNamespaceTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(aggregateRegisterNamespaceTransactionDTO);
                ValidateTransaction_1.default.validateAggregateTx(aggregateRegisterNamespaceTransaction, aggregateRegisterNamespaceTransactionDTO);
            });
        });
    ...
    describe('MosaicDefinitionTransaction', () => {
        it('standalone', () => {
            ...
            const mosaicDefinitionTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(mosaicDefinitionTransactionDTO);
            ValidateTransaction_1.default.validateStandaloneTx(mosaicDefinitionTransaction, mosaicDefinitionTransactionDTO);
        });
        it('aggregate', () => {
            ...
            const aggregateRegisterNamespaceTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(aggregateMosaicDefinitionTransactionDTO);
            ValidateTransaction_1.default.validateAggregateTx(aggregateRegisterNamespaceTransaction, aggregateMosaicDefinitionTransactionDTO);
        });
    });
    describe('MosaicSupplyChangeTransaction', () => {
        it('standalone', () => {
            ...
            const mosaicSupplyChangeTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(mosaicSupplyChangeTransactionDTO);
            ValidateTransaction_1.default.validateStandaloneTx(mosaicSupplyChangeTransaction, mosaicSupplyChangeTransactionDTO);
        });
        it('aggregate', () => {
            ...
            const aggregateMosaicSupplyChangeTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(aggregateMosaicSupplyChangeTransactionDTO);
            ValidateTransaction_1.default.validateAggregateTx(aggregateMosaicSupplyChangeTransaction, aggregateMosaicSupplyChangeTransactionDTO);
        });
    });
    describe('ModifyMultisigAccountTransaction', () => {
        it('standalone', () => {
            ...
            const modifyMultisigAccountTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(modifyMultisigAccountTransactionDTO);
            ValidateTransaction_1.default.validateStandaloneTx(modifyMultisigAccountTransaction, modifyMultisigAccountTransactionDTO);
        });
        it('aggregate', () => {
            ...
            const aggregateModifyMultisigAccountTransaction = CreateTransactionFromDTO_1.CreateTransactionFromDTO(aggregateModifyMultisigAccountTransactionDTO);
            ValidateTransaction_1.default.validateAggregateTx(aggregateModifyMultisigAccountTransaction, aggregateModifyMultisigAccountTransactionDTO);
        });
    });
});
//# sourceMappingURL=CreateTransactionFromDTO.spec.js.map