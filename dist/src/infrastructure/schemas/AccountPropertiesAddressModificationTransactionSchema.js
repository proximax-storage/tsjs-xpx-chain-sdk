...
exports.default = new Schema_1.Schema([
    ...
    Schema_1.ubyte('propertyType'),
    Schema_1.ubyte('modificationCount'),
    Schema_1.tableArray('modifications', [
        Schema_1.ubyte('modificationType'),
        Schema_1.array('value', Schema_1.TypeSize.BYTE)
    ])
]);
//# sourceMappingURL=AccountPropertiesAddressModificationTransactionSchema.js.map