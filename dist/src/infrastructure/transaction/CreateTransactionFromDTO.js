...
const js_xpx_catapult_library_2 = require("js-xpx-catapult-library");
...
exports.extractRecipient = (recipient) => {
    if (typeof recipient === 'string') {
        ...
        // Else (e.g. 0x91) it represents a namespace id which starts at byte 1.
        const bit0 = js_xpx_catapult_library_1.convert.hexToUint8(recipient.substr(1, 2))[0];
        if ((bit0 & 16) === 16) {
...
exports.extractMosaics = (mosaics) => {
    ...
    return mosaics.map((mosaicDTO) => {
        ...
        const bytes = js_xpx_catapult_library_1.convert.hexToUint8(js_xpx_catapult_library_2.uint64.toHex(uint64.toDTO()));
        const byte0 = bytes[0];
