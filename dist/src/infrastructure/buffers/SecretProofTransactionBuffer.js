 ...
 * @returns {number}
 */
Catapult.Buffers.SecretProofTransactionBuffer.prototype.maxFee = function (index) {
 ...
 * @returns {number}
 */
Catapult.Buffers.SecretProofTransactionBuffer.prototype.maxFeeLength = function () {
    var offset = this.bb.__offset(this.bb_pos, 14);
    return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
};
/**
 * @returns {Uint32Array}
 */
Catapult.Buffers.SecretProofTransactionBuffer.prototype.maxFeeArray = function () {
    var offset = this.bb.__offset(this.bb_pos, 14);
 ...
 */
Catapult.Buffers.SecretProofTransactionBuffer.addMaxFee = function (builder, maxFeeOffset) {
 ...
 * @returns {flatbuffers.Offset}
 */
Catapult.Buffers.SecretProofTransactionBuffer.createMaxFeeVector = function (builder, data) {
 ...
 * @param {number} numElems
 */
Catapult.Buffers.SecretProofTransactionBuffer.startMaxFeeVector = function (builder, numElems) {
 ...
 * @returns {flatbuffers.Offset}
 */
Catapult.Buffers.SecretProofTransactionBuffer.createSecretProofTransactionBuffer = function (builder, size, signatureOffset, signerOffset, version, type, maxFeeOffset, deadlineOffset, hashAlgorithm, secretOffset, recipientOffset, proofSize, proofOffset) {
    Catapult.Buffers.SecretProofTransactionBuffer.startSecretProofTransactionBuffer(builder);
    Catapult.Buffers.SecretProofTransactionBuffer.addSize(builder, size);
    Catapult.Buffers.SecretProofTransactionBuffer.addSignature(builder, signatureOffset);
    Catapult.Buffers.SecretProofTransactionBuffer.addSigner(builder, signerOffset);
    Catapult.Buffers.SecretProofTransactionBuffer.addVersion(builder, version);
    Catapult.Buffers.SecretProofTransactionBuffer.addType(builder, type);
    Catapult.Buffers.SecretProofTransactionBuffer.addMaxFee(builder, maxFeeOffset);
    Catapult.Buffers.SecretProofTransactionBuffer.addDeadline(builder, deadlineOffset);
    Catapult.Buffers.SecretProofTransactionBuffer.addHashAlgorithm(builder, hashAlgorithm);
    Catapult.Buffers.SecretProofTransactionBuffer.addSecret(builder, secretOffset);
    Catapult.Buffers.SecretProofTransactionBuffer.addRecipient(builder, recipientOffset);
    Catapult.Buffers.SecretProofTransactionBuffer.addProofSize(builder, proofSize);
    Catapult.Buffers.SecretProofTransactionBuffer.addProof(builder, proofOffset);
    return Catapult.Buffers.SecretProofTransactionBuffer.endSecretProofTransactionBuffer(builder);
};
