 ...
 * @returns {flatbuffers.Offset}
 */
Catapult.Buffers.SecretLockTransactionBuffer.createSecretLockTransactionBuffer = function (builder, size, signatureOffset, signerOffset, version, type, maxFeeOffset, deadlineOffset, mosaicIdOffset, mosaicAmountOffset, durationOffset, hashAlgorithm, secretOffset, recipientOffset) {
    Catapult.Buffers.SecretLockTransactionBuffer.startSecretLockTransactionBuffer(builder);
    Catapult.Buffers.SecretLockTransactionBuffer.addSize(builder, size);
    Catapult.Buffers.SecretLockTransactionBuffer.addSignature(builder, signatureOffset);
    Catapult.Buffers.SecretLockTransactionBuffer.addSigner(builder, signerOffset);
    Catapult.Buffers.SecretLockTransactionBuffer.addVersion(builder, version);
    Catapult.Buffers.SecretLockTransactionBuffer.addType(builder, type);
    Catapult.Buffers.SecretLockTransactionBuffer.addMaxFee(builder, maxFeeOffset);
    Catapult.Buffers.SecretLockTransactionBuffer.addDeadline(builder, deadlineOffset);
    Catapult.Buffers.SecretLockTransactionBuffer.addMosaicId(builder, mosaicIdOffset);
    Catapult.Buffers.SecretLockTransactionBuffer.addMosaicAmount(builder, mosaicAmountOffset);
    Catapult.Buffers.SecretLockTransactionBuffer.addDuration(builder, durationOffset);
    Catapult.Buffers.SecretLockTransactionBuffer.addHashAlgorithm(builder, hashAlgorithm);
    Catapult.Buffers.SecretLockTransactionBuffer.addSecret(builder, secretOffset);
