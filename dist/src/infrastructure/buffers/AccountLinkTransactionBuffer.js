 ...
 * @returns {flatbuffers.Offset}
 */
Catapult.Buffers.AccountLinkTransactionBuffer.createAccountLinkTransactionBuffer = function (builder, size, signatureOffset, signerOffset, version, type, maxFeeOffset, deadlineOffset, remoteAccountKeyOffset, linkAction) {
    Catapult.Buffers.AccountLinkTransactionBuffer.startAccountLinkTransactionBuffer(builder);
    Catapult.Buffers.AccountLinkTransactionBuffer.addSize(builder, size);
    Catapult.Buffers.AccountLinkTransactionBuffer.addSignature(builder, signatureOffset);
    Catapult.Buffers.AccountLinkTransactionBuffer.addSigner(builder, signerOffset);
    Catapult.Buffers.AccountLinkTransactionBuffer.addVersion(builder, version);
    Catapult.Buffers.AccountLinkTransactionBuffer.addType(builder, type);
    Catapult.Buffers.AccountLinkTransactionBuffer.addMaxFee(builder, maxFeeOffset);
    Catapult.Buffers.AccountLinkTransactionBuffer.addDeadline(builder, deadlineOffset);
    Catapult.Buffers.AccountLinkTransactionBuffer.addRemoteAccountKey(builder, remoteAccountKeyOffset);
