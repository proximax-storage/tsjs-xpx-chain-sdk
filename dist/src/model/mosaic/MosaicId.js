...
class MosaicId {
    ...
    static createFromNonce(nonce, owner) {
        const mosaicId = js_xpx_catapult_library_1.mosaicId(nonce.nonce, js_xpx_catapult_library_1.convert.hexToUint8(owner.publicKey));
    ...
    constructor(id) {
        if (id instanceof Array) {
            ...
            this.id = new Id_1.Id(js_xpx_catapult_library_1.uint64.fromHex(id));
        }
    }
    /**
