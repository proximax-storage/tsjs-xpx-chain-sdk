...
const AccountPropertiesAddressTransaction_1 = require("../../infrastructure/builders/AccountPropertiesAddressTransaction");
...
class ModifyAccountPropertyAddressTransaction extends Transaction_1.Transaction {
     ...
     */
    buildTransaction() {
        return new AccountPropertiesAddressTransaction_1.Builder()
