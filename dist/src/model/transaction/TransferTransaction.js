...
class TransferTransaction extends Transaction_1.Transaction {
    ...
    get size() {
        ...
        const bytePayload = js_xpx_catapult_library_1.convert.hexToUint8(js_xpx_catapult_library_1.convert.utf8ToHex(this.message.payload || '')).length;
     ...
     */
    buildTransaction() {
        return new js_xpx_catapult_library_1.TransferTransaction.Builder()
