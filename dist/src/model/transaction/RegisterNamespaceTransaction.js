...
class RegisterNamespaceTransaction extends Transaction_1.Transaction {
    ...
    static createSubNamespace(deadline, namespaceName, parentNamespace, networkType, maxFee = new UInt64_1.UInt64([0, 0])) {
        ...
        if (typeof parentNamespace === 'string') {
            parentId = new NamespaceId_1.NamespaceId(js_xpx_catapult_library_1.subnamespaceParentId(parentNamespace, namespaceName));
        }
        else {
        ...
        return new RegisterNamespaceTransaction(networkType, TransactionVersion_1.TransactionVersion.REGISTER_NAMESPACE, deadline, maxFee, NamespaceType_1.NamespaceType.SubNamespace, namespaceName, typeof parentNamespace === 'string' ?
            new NamespaceId_1.NamespaceId(js_xpx_catapult_library_1.subnamespaceNamespaceId(parentNamespace, namespaceName)) :
            new NamespaceId_1.NamespaceId(js_xpx_catapult_library_1.namespaceId(namespaceName)), undefined, parentId);
    }
    /**
    ...
    get size() {
        ...
        const byteName = js_xpx_catapult_library_1.convert.utf8ToHex(this.namespaceName).length / 2;
     ...
     */
    buildTransaction() {
        let registerNamespacetransaction = new js_xpx_catapult_library_1.NamespaceCreationTransaction.Builder()
