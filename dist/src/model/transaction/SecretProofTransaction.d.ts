...
export declare class SecretProofTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, hashType: HashType, secret: string, proof: string, networkType: NetworkType, maxFee?: UInt64): SecretProofTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
     ...
     */
    constructor(networkType: NetworkType, version: number, deadline: Deadline, maxFee: UInt64, hashType: HashType, secret: string, proof: string, signature?: string, signer?: PublicAccount, transactionInfo?: TransactionInfo);
    /**
