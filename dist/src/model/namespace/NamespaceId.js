...
class NamespaceId {
    ...
    constructor(id) {
        if (id instanceof Array) {
            ...
            this.fullName = id;
            this.id = new Id_1.Id(js_xpx_catapult_library_1.namespaceId(id));
        }
    }
    /**
    ...
    static createFromEncoded(encoded) {
        const uint = js_xpx_catapult_library_1.convert.hexToUint8(encoded).reverse();
        const hex = js_xpx_catapult_library_1.convert.uint8ToHex(uint);
