...
describe('key pair', () => {
    ...
    describe('derive shared key', () => {
        ...
        it('can derive deterministic shared key from well known inputs', () => {
            // Arrange:
            const privateKey = format_1.Convert.hexToUint8('8F545C2816788AB41D352F236D80DBBCBC34705B5F902EFF1F1D88327C7C1300');
            ...
            // Act:
            const sharedKey = crypto_1.KeyPair.deriveSharedKey({
                privateKey,
            }, publicKey, salt);
            // Assert:
