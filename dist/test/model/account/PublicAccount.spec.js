...
describe('Signature verification', () => {
    it('Can verify a signature', () => {
        // Arrange:'
        const signerPublicAccount = PublicAccount_1.PublicAccount.createFromPublicKey('1464953393CE96A08ABA6184601FD08864E910696B060FF7064474726E666CA8', NetworkType_1.NetworkType.MIJIN_TEST);
    ...
    it('Throw error if signature has invalid length', () => {
        // Arrange:
        const signerPublicAccount = PublicAccount_1.PublicAccount.createFromPublicKey('22816F825B4CACEA334723D51297D8582332D8B875A5829908AAE85831ABB508', NetworkType_1.NetworkType.MIJIN_TEST);
        const data = 'I am so so so awesome as always';
        ...
        // Act & Assert:
        chai_1.expect(() => { signerPublicAccount.verifySignature(data, signature); }).to.throw('Signature length is incorrect');
    });
    it('Throw error if signature is not strictly hexadecimal', () => {
        ...
        // Act & Assert:
        chai_1.expect(() => { signerPublicAccount.verifySignature(data, signature); })
            .to.throw('Signature must be hexadecimal only');
    });
    it('Return false if wrong public key provided', () => {
        // Arrange:
        const signerPublicAccount = PublicAccount_1.PublicAccount.createFromPublicKey('12816F825B4CACEA334723D51297D8582332D8B875A5829908AAE85831ABB509', NetworkType_1.NetworkType.MIJIN_TEST);
        const data = 'I am so so so awesome as always';
        ...
        // Act & Assert:
        chai_1.expect(signerPublicAccount.verifySignature(data, signature)).to.be.false;
    });
...
//# sourceMappingURL=PublicAccount.spec.js.map