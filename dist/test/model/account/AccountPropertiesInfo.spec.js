...
describe('AccountPropertiesInfo', () => {
    it('should createComplete an AccountPropertiesInfo object', () => {
        ...
        assert_1.deepEqual(accountPropertiesInfo.accountProperties.address, accountPropertiesInfoDTO.accountProperties.address);
        ...
        assert_1.deepEqual(accountPropertiesInfo.accountProperties.properties[0].values[0], accountPropertiesInfoDTO.accountProperties.properties[0].values[0]);
    });
});
