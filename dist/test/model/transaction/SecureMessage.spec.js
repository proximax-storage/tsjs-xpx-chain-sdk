...
const SecureMessage_1 = require("../../../src/model/transaction/SecureMessage");
describe('SecureMessage', () => {
    it('should create secure message and decrypt message with sender private key ', () => {
        ...
        const secureMessage = SecureMessage_1.SecureMessage.create(payload, recipientPublicKey, senderPrivateKey);
        const decodedMessagePayload = secureMessage.decrypt(recipientPublicKey, senderPrivateKey);
        chai_1.expect(decodedMessagePayload).to.be.equal(payload);
    });
    it('should create secure message and decrypt message with receiver private key', () => {
        ...
        const recipientPrivateKey = 'B226CAEBCCA25566B2961023A8259A00EC7FCAFB2BAA408B78BB6E2E292E07C0';
        const recipientPublicKey = '633FD217940F7FEB21FF6477DEBF6ADECDA2891561276AFC393D979E14470B39';
        const secureMessage = SecureMessage_1.SecureMessage.create(payload, senderPublicKey, recipientPrivateKey);
    ...
    it('should decrypt payload uploaded from java sdk with sender private key', () => {
        ...
        const secureMessage = SecureMessage_1.SecureMessage.createFromDTO(payload);
...
//# sourceMappingURL=SecureMessage.spec.js.map