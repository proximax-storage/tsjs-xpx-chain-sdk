...
describe('CosignatureTransaction', () => {
    ...
    it('should createComplete an TransferTransaction object and sign it', () => {
        ...
        const cosignatureTransaction = CosignatureTransaction_1.CosignatureTransaction.create(aggregateTransferTransaction);
        const cosignatureSignedTransaction = account.signCosignatureTransaction(cosignatureTransaction);
        chai_1.expect(cosignatureSignedTransaction.parentHash).to.be.equal(aggregateTransferTransaction.transactionInfo.hash);
