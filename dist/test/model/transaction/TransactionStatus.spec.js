...
describe('TransactionStatus', () => {
    it('should createComplete TransactionStatus object', () => {
        ...
        const transactionStatus = new TransactionStatus_1.TransactionStatus(transactionStatusDTO.group, transactionStatusDTO.status, transactionStatusDTO.hash, transactionStatusDTO.deadline, transactionStatusDTO.height);
