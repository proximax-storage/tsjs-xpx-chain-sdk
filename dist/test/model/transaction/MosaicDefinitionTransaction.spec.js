...
describe('MosaicDefinitionTransaction', () => {
    ...
    it('should createComplete an MosaicDefinitionTransaction object and sign it with flags 7', () => {
        ...
        chai_1.expect(mosaicDefinitionTransaction.mosaicProperties.levyMutable).to.be.equal(true);
        const signedTransaction = mosaicDefinitionTransaction.signWith(account);
        chai_1.expect(signedTransaction.payload.substring(240, signedTransaction.payload.length)).to.be.equal('E6DE84B8010000000000000001070302E803000000000000');
    });
    it('should createComplete an MosaicDefinitionTransaction object and sign it with flags 0', () => {
        ...
        chai_1.expect(mosaicDefinitionTransaction.mosaicProperties.levyMutable).to.be.equal(false);
        const signedTransaction = mosaicDefinitionTransaction.signWith(account);
