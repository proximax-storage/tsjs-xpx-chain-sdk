...
describe('AccountPropertyTransaction', () => {
    ...
    it('should create address property filter', () => {
        ...
        const addressPropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createAddressFilter(model_1.PropertyModificationType.Add, address);
        chai_1.expect(addressPropertyFilter.modificationType).to.be.equal(model_1.PropertyModificationType.Add);
    ...
    it('should create mosaic property filter', () => {
        ...
        const mosaicPropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createMosaicFilter(model_1.PropertyModificationType.Add, mosaicId);
        chai_1.expect(mosaicPropertyFilter.modificationType).to.be.equal(model_1.PropertyModificationType.Add);
    ...
    it('should create entity type property filter', () => {
        const entityType = model_1.TransactionType.ADDRESS_ALIAS;
        const entityTypePropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createEntityTypeFilter(model_1.PropertyModificationType.Add, entityType);
        chai_1.expect(entityTypePropertyFilter.modificationType).to.be.equal(model_1.PropertyModificationType.Add);
    ...
    describe('size', () => {
        it('should return 148 for ModifyAccountPropertyAddressTransaction transaction byte size with 1 modification', () => {
            const address = Address_1.Address.createFromRawAddress('SBILTA367K2LX2FEXG5TFWAS7GEFYAGY7QLFBYKC');
            const addressPropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createAddressFilter(model_1.PropertyModificationType.Add, address);
            const addressPropertyTransaction = AccountPropertyTransaction_1.AccountPropertyTransaction.createAddressPropertyModificationTransaction(Deadline_1.Deadline.create(), model_1.PropertyType.AllowAddress, [addressPropertyFilter], NetworkType_1.NetworkType.MIJIN_TEST);
        ...
        it('should return 131 for ModifyAccountPropertyMosaicTransaction transaction byte size with 1 modification', () => {
            const mosaicId = new MosaicId_1.MosaicId([2262289484, 3405110546]);
            const mosaicPropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createMosaicFilter(model_1.PropertyModificationType.Add, mosaicId);
            const mosaicPropertyTransaction = AccountPropertyTransaction_1.AccountPropertyTransaction.createMosaicPropertyModificationTransaction(Deadline_1.Deadline.create(), model_1.PropertyType.AllowMosaic, [mosaicPropertyFilter], NetworkType_1.NetworkType.MIJIN_TEST);
        ...
        it('should return 125 for ModifyAccountPropertyEntityTypeTransaction transaction byte size with 1 modification', () => {
            const entityType = model_1.TransactionType.ADDRESS_ALIAS;
            const entityTypePropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createEntityTypeFilter(model_1.PropertyModificationType.Add, entityType);
            const entityTypePropertyTransaction = AccountPropertyTransaction_1.AccountPropertyTransaction.createEntityTypePropertyModificationTransaction(Deadline_1.Deadline.create(), model_1.PropertyType.AllowTransaction, [entityTypePropertyFilter], NetworkType_1.NetworkType.MIJIN_TEST);
    ...
    it('should filled maxFee override transaction maxFee', () => {
        const address = Address_1.Address.createFromRawAddress('SBILTA367K2LX2FEXG5TFWAS7GEFYAGY7QLFBYKC');
        const addressPropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createAddressFilter(model_1.PropertyModificationType.Add, address);
        const addressPropertyTransaction = AccountPropertyTransaction_1.AccountPropertyTransaction.createAddressPropertyModificationTransaction(Deadline_1.Deadline.create(), model_1.PropertyType.AllowAddress, [addressPropertyFilter], NetworkType_1.NetworkType.MIJIN_TEST, new UInt64_1.UInt64([1, 0]));
        chai_1.expect(addressPropertyTransaction.maxFee.higher).to.be.equal(0);
    ...
    it('should throw exception when create address property transaction with wrong type', () => {
        ...
        const addressPropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createAddressFilter(model_1.PropertyModificationType.Add, address);
        chai_1.expect(() => {
            AccountPropertyTransaction_1.AccountPropertyTransaction.createAddressPropertyModificationTransaction(Deadline_1.Deadline.create(), model_1.PropertyType.Sentinel, [addressPropertyFilter], NetworkType_1.NetworkType.MIJIN_TEST);
    ...
    it('should throw exception when create mosaic property transaction with wrong type', () => {
        ...
        const mosaicPropertyFilter = AccountPropertyTransaction_1.AccountPropertyTransaction.createMosaicFilter(model_1.PropertyModificationType.Add, mosaicId);
        chai_1.expect(() => {
            AccountPropertyTransaction_1.AccountPropertyTransaction.createMosaicPropertyModificationTransaction(Deadline_1.Deadline.create(), model_1.PropertyType.Sentinel, [mosaicPropertyFilter], NetworkType_1.NetworkType.MIJIN_TEST);
        }).to.throw(Error, 'Property type is not allowed.');
    });
