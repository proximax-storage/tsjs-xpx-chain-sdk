...
export class AccountMosaicRestrictionTransactionBuffer {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AccountMosaicRestrictionTransactionBuffer {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAccountMosaicRestrictionTransactionBuffer(bb:flatbuffers.ByteBuffer, obj?:AccountMosaicRestrictionTransactionBuffer):AccountMosaicRestrictionTransactionBuffer {
  return (obj || new AccountMosaicRestrictionTransactionBuffer()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAccountMosaicRestrictionTransactionBuffer(bb:flatbuffers.ByteBuffer, obj?:AccountMosaicRestrictionTransactionBuffer):AccountMosaicRestrictionTransactionBuffer {
...
restrictionAdditions(index: number, obj?:MosaicId):MosaicId|null {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? (obj || new MosaicId()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
restrictionDeletions(index: number, obj?:MosaicId):MosaicId|null {
...
static startAccountMosaicRestrictionTransactionBuffer(builder:flatbuffers.Builder) {
...
static endAccountMosaicRestrictionTransactionBuffer(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createAccountMosaicRestrictionTransactionBuffer(builder:flatbuffers.Builder, size:number, signatureOffset:flatbuffers.Offset, signerOffset:flatbuffers.Offset, version:number, type:number, maxFeeOffset:flatbuffers.Offset, deadlineOffset:flatbuffers.Offset, restrictionFlags:number, restrictionAdditionsCount:number, restrictionDeletionsCount:number, accountRestrictionTransactionBodyReserved1:number, restrictionAdditionsOffset:flatbuffers.Offset, restrictionDeletionsOffset:flatbuffers.Offset):flatbuffers.Offset {
  AccountMosaicRestrictionTransactionBuffer.startAccountMosaicRestrictionTransactionBuffer(builder);
  AccountMosaicRestrictionTransactionBuffer.addSize(builder, size);
  AccountMosaicRestrictionTransactionBuffer.addSignature(builder, signatureOffset);
  AccountMosaicRestrictionTransactionBuffer.addSigner(builder, signerOffset);
  AccountMosaicRestrictionTransactionBuffer.addVersion(builder, version);
  AccountMosaicRestrictionTransactionBuffer.addType(builder, type);
  AccountMosaicRestrictionTransactionBuffer.addMaxFee(builder, maxFeeOffset);
  AccountMosaicRestrictionTransactionBuffer.addDeadline(builder, deadlineOffset);
  AccountMosaicRestrictionTransactionBuffer.addRestrictionFlags(builder, restrictionFlags);
  AccountMosaicRestrictionTransactionBuffer.addRestrictionAdditionsCount(builder, restrictionAdditionsCount);
  AccountMosaicRestrictionTransactionBuffer.addRestrictionDeletionsCount(builder, restrictionDeletionsCount);
  AccountMosaicRestrictionTransactionBuffer.addAccountRestrictionTransactionBodyReserved1(builder, accountRestrictionTransactionBodyReserved1);
  AccountMosaicRestrictionTransactionBuffer.addRestrictionAdditions(builder, restrictionAdditionsOffset);
  AccountMosaicRestrictionTransactionBuffer.addRestrictionDeletions(builder, restrictionDeletionsOffset);
  return AccountMosaicRestrictionTransactionBuffer.endAccountMosaicRestrictionTransactionBuffer(builder);
}
}
