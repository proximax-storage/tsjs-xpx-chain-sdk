...
export class UpgradeRoutesApi {
     ...
     */
    public async getUpgrade (height: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BlockchainUpgradeDTO;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BlockchainUpgradeDTO;  }>((resolve, reject) => {
