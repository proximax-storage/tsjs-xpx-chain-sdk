...
export class ServiceRoutesApi {
     ...
     */
    public async getAccountDrives (accountId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse200;  }> {
